...
X <- read.csv(
    "../results/training/bart_mia_input/Uganda_X_train.csv"
)

y_df <- read.csv(
    "../results/training/bart_mia_input/Uganda_y_train.csv"
)

fold_df <- read.csv(
    "../results/training/cv_folds/Uganda_folds.csv"
)
...
saveRDS(
    bart_model,
    "../results/models/BART_MIA_Uganda.rds"
)
...
write.csv(
    results,
    "../results/training/BART_MIA_Uganda_results.csv",
    row.names = FALSE
)
...
cat("\n")
cat("\n")
cat("BART-MIA Uganda TRAINING: COMPLETED\n")
cat("\n")
