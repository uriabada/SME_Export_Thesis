...
X <- read.csv(
    "../results/training/bart_mia_input/Tanzania_X_train.csv"
)

y_df <- read.csv(
    "../results/training/bart_mia_input/Tanzania_y_train.csv"
)

fold_df <- read.csv(
    "../results/training/cv_folds/Tanzania_folds.csv"
)
...
saveRDS(
    bart_model,
    "../results/models/BART_MIA_Tanzania.rds"
)
...
write.csv(
    results,
    "../results/training/BART_MIA_Tanzania_results.csv",
    row.names = FALSE
)
...
cat("\n")
cat("\n")
cat("BART-MIA Tanzania TRAINING: COMPLETED\n")
cat("\n")
